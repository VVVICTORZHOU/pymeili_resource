...
# Define colors list / 自定義顏色清單
colorscode = ['#000000', '#0000FF', '#00FFFF', '#00FF00', '#FFFF00', '#FF0000', '#FF00FF', '#FFFFFF']
colorslev = [-2, -0.7, -0.3, 0, 0.3, 0.7, 1.2, 1.7, 2]
...
bp.drawcountries()
bp.drawmapboundary()
bp.contourf(x=X, y=Y, z=Z_data, levels=colorslev, colors=colorscode, hatches=['-', '/', '\\', '//']) # use colors instead of cmap / 使用 colors 色階模式而非 cmap
bp.colorbar(ax=ax4, label='Z', ticks=[-2,-0.5,0,0.5,1,2])
